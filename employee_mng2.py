        ...
        try:
            ...
            if len(str(mobile_no)) == 10:
                ...
                if "@" and "gmail.com" in mail_id:
                    ...
                    self.attendance2.update({self.emp_id:10})
                    print("\nSee Employee Dictionary:\n",self.dict1)
                    print("\n!!_ _ _ _ Employee Added Successfully _ _ _ _!!")

                    message = f"""From: From Person <surajmkhandagale78@gmail.com>
                    To: TO Person <{mail_id}>
                    ...
                    smtpObj.sendmail('surajmkhandagale78@gmail.com',f'{mail_id}',message)
